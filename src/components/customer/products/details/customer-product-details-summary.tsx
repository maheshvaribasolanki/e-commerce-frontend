...
const actionButtonsClass = "flex flex-col gap-3 sm:flex-row pt-2";

const primaryButtonClass = "rounded-2xl h-12 text-base font-semibold sm:flex-1 shadow-md shadow-primary/20 hover:shadow-lg transition-all";

const secondaryButtonClass = "rounded-2xl h-12 text-base font-semibold sm:flex-1 transition-all";
