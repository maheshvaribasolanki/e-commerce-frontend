...
const sortTriggerClass = "w-[180px] rounded-xl bg-card border-border/80";
...
const activeBadgeClass =
  "border-border bg-secondary px-3 py-1 text-xs rounded-full text-secondary-foreground hover:bg-secondary";

const topBarActionsClass = "flex items-center gap-3";

const mobileFilterButtonClass = "rounded-xl lg:hidden";
...
const desktopFilterCardClass = "sticky top-24 rounded-3xl border border-border/60 bg-card/80 p-5 shadow-sm backdrop-blur";

const productSectionClass = "space-y-6";

const actionButtonClass = "rounded-xl";
