...
import { ArrowRight, Grid2X2, TicketPercent, ShoppingBag, Copy } from "lucide-react";
import { useEffect } from "react";
import { Link } from "react-router-dom";
import { toast } from "sonner";
import { HeroBannerCarousel } from "@/components/customer/home/hero-banner-carousel";
    ...
    <div className={pageWrapClass}>
      <div className={contentContainerClass}>
        <div className={sectionStackClass}>
          ...
          <HeroBannerCarousel banners={data?.banners || []} />
            ...
            <section>
              ...
              <div className={couponGridClass}>
                {data.coupons.slice(0, 4).map((coupon) => (
                  <Card
                    key={coupon._id}
                    className={`${couponCardClass} cursor-pointer hover:scale-[1.02] transition-transform`}
                    onClick={() => {
                  ...
                  >
                    <CardContent className={couponContentClass}>
                      ...
                      <div className={couponCodeWrapClass}>
                        <p className={couponCodeLabelClass}>Click to copy code</p>
                        <div className="flex items-center justify-between">
